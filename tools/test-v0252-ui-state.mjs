...
assert.equal(getVisibleAchievementEntries({ definitions: achievementDefinitions, achievementState: hiddenLockedState }).length, 2, "未解鎖隱藏成就不可洩漏");
hiddenLockedState.goblin_camp_clear.unlocked = true;
assert.equal(getVisibleAchievementEntries({ definitions: achievementDefinitions, achievementState: hiddenLockedState }).length, 3);
